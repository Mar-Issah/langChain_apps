...
def get_response(query, age, tasktype_option):
        ...
        examples = [
{
        ...
        examples = [
   {
    ...
    elif age=="Senior Citizen": #A 90 years old guys
        examples = [
      {
            "query": "What is a smartphone?",
    ...
    # Ensuring the AI doesn’t generate a text beyond its context window but based on the users response length selection
